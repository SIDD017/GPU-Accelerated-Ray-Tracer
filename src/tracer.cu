...
__global__ void create_world(hitable **d_list, hitable **d_world, camera **d_camera, int nx, int ny, camera_properties cam) {
...
void Tracer::draw(int tx, int ty, cudaGraphicsResource_t resource, camera_properties cam) {
    uint32_t* dev_ptr;
    size_t pbo_size;
